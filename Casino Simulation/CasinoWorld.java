    ...
    public void act(){
        ...
        if(placed!=14&&UIManager.getCasinoProfit()/2>UIManager.getCasinoTarget()*0.05){
            ...
            switch(placed){
                ...
                case 12:addObject(new Roulette(new SpotManager.Spot[]{new SpotManager.Spot(1152,241,-120), new SpotManager.Spot(1148,290,-80), new SpotManager.Spot(1116,320,-45), new SpotManager.Spot(1068,335,-30), new SpotManager.Spot(1014,330,-40), new SpotManager.Spot(976,302,-60)}),1060,270);break;
