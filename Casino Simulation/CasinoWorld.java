...
public class CasinoWorld extends World
{
    ...
    public void act(){
        ...
        if(progressLevel==1 && 20 == (HorizontalBar.casinoProfit*100)/casinoTarget){
            ...
            // add horsebetting
            addObject(new HorseBetting(new SpotManager.Spot[]{new SpotManager.Spot(740,285,-80), new SpotManager.Spot(798,280,-80), new SpotManager.Spot(758+3*30,275,-80), new SpotManager.Spot(758+2*48,255,-80), new SpotManager.Spot(710+48,250,-80), new SpotManager.Spot(710,245,-80), new SpotManager.Spot(678,245,-80)}),781,187);
