...
public class CasinoWorld extends World
{
    ...
    public void act(){
        if(--delay==0){
            ...
            //Game tempGame=null;
            //if(emptyGame())
            addObject(new Ordinary(),(Greenfoot.getRandomNumber(2)==0?1250:-50),690+(Greenfoot.getRandomNumber(2)==0?-Greenfoot.getRandomNumber(20):Greenfoot.getRandomNumber(20)));
        }
    }
    /*
